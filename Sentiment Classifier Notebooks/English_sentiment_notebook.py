# -*- coding: utf-8 -*-
"""BERT for sentiment analysis (English).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CzDVzvBm3A_IlsKt2FgDGbPcm090VnM9
"""
...
# The library we'll be using to import and build our model (BERTForSequenceClassification)
...
# The tokenizer we'll be using for our tweets; documentation: https://huggingface.co/transformers/model_doc/bert.html
from transformers import BertTokenizer

# Load the BERT tokenizer.
tokenizer = BertTokenizer.from_pretrained('bert-base-uncased', do_lower_case=True) # Note 'uncased'
...
from transformers import get_linear_schedule_with_warmup # Used to automatically adjust the learning rate during training to aid the optimization process
...
test_data_labels = test_data_sentiments # Fetches the sentiment values from our test dataset 
